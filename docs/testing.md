...
| `test_documentation_structure.py` | camadas de UI, ciclo numérico versionado do changelog, contrato da pré-release contínua e sincronização entre árvore, inventários técnicos e guia para agentes |
